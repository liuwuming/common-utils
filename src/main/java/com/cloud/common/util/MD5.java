...
public class MD5 {
	...
	public String getMD5ofStr(String s) {// ����MD5����
		int i;
		md5Init();
	...
	private void md5Update(byte abyte0[], int i) {// ��λ������abyte0Ϊ��Ҫ����MD5���ܵ��ַ�iΪ�ַ��ȣ�
	...
	private void md5Final() {// ���մ��?���õ���128λ��16�ֽڣ�MD5������digest������
	...
	private void Encode(byte abyte0[], long al[], int i) {// ת������al��long�͵ı��������byte�͵�����abyte0�У�
		// ��λ�ֽ���ǰ����λ�ֽ��ں�
		int j = 0;
		for (int k = 0; k < i; k += 4) {
